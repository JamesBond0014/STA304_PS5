...
A noticeable strength of these data sets however is lack of bias. Since these projects are started with the mission objective of finding as many cases of police use of deadly force as possible, it is reasonable to assume that researchers well attempt to find every case possible in order to represent the entire picture. Since both data sets used are crowd sourced, the public can and are encouraged to provide information on missed data, and the responsible organization will use reliable sources to confirm new names to be added.
